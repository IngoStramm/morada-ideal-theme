...
/**
 * mi_register_required_plugins
 *
 * @param  array $plugin_array
 * @return array
 */
function mi_register_required_plugins($plugin_array)
{
...
add_action('admin_notices', 'mi_admin_notice__warning');

/**
 * mi_admin_notice__warning
 *
 * @return string
 */
function mi_admin_notice__warning()
{
    ...
    $need_plugin = false;
    $plugins = mi_register_required_plugins($required_plugins);
