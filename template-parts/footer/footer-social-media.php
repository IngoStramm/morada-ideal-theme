...
if (
    ...
    <div class="wd-social">
        <span><?php _e('Siga-nos', 'mi'); ?></span>
        <ul class="list-social d-flex align-items-center">

            <?php if ($facebook_url) { ?>
                <li>
                    <a href="<?php echo $facebook_url; ?>" class="box-icon w-40 social">
            ...
            <?php if ($linkedin_url) { ?>
                <li><a href="<?php echo $linkedin_url; ?>" class="box-icon w-40 social">
            ...
            <?php if ($x_url) { ?>
                <li><a href="<?php echo $x_url; ?>" class="box-icon w-40 social">
            ...
            <?php if ($pinterest_url) { ?>
                <li><a href="<?php echo $pinterest_url; ?>" class="box-icon w-40 social">
            ...
            <?php if ($instagram_url) { ?>
                <li><a href="<?php echo $instagram_url; ?>" class="box-icon w-40 social">
                        <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <?php if ($youtube_url) { ?>
                <li><a href="<?php echo $youtube_url; ?>" class="box-icon w-40 social">
