    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="flat-account">
                ...
                <?php } ?>
                <form class="form-account needs-validation" name="loginform" id="loginform" action="<?php echo esc_url(admin_url('admin-post.php')); ?>" method="post" novalidate>
                    <div class="title-box">
                        <h4><?php the_title(); ?></h4>
                    </div>
                    <div class="box">
                        <fieldset class="box-fieldset">
                            ...
                            <div class="ip-field">
                                ...
                                <input type="text" class="form-control" id="user_login" name="log" placeholder="<?php _e('Seu e-mail', 'mi'); ?>" required>
                                <div class="invalid-feedback ps-5"><?php _e('Campo obrigatório', 'mi'); ?></div>
                            </div>
                        </fieldset>
                        <fieldset class="box-fieldset">
                            <label for="user_pass"><?php _e('Palavra-passe', 'mi'); ?></label>
                            <div class="ip-field">
                                <svg class="icon" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <input type="password" class="form-control" id="user_pass" name="pwd" placeholder="<?php _e('Sua palavra-passe', 'mi'); ?>" required>
                                <div class="invalid-feedback ps-5"><?php _e('Campo obrigatório', 'mi'); ?></div>
                            </div>
