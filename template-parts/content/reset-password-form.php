...
if (!$key) {
    $_SESSION['mi_resetpassword_error_message'] = __('Chave de redefinição de palavra-passe ausente. Utilize o link enviado por e-mail para acessar esta página.', 'mi');
}
                    ...
                    <div class="box">
                        <fieldset class="box-fieldset">
                            ...
                            <div class="ip-field">
                                ...
                                <input type="password" class="form-control" id="user_pass" name="user_pass" placeholder="<?php _e('Palavra-passe', 'mi'); ?>" required>
