    ...
    <div class="homelengo-box list-style-1 list-style-2 line">
        <div class="archive-top">
            <a href="<?php echo get_permalink(); ?>" class="images-group">
                <div class="images-style">
                    ...
                    ?>
                    <img class="lazyload" data-src="<?php echo $post_thumbnail_url; ?>" src="<?php echo $post_thumbnail_url; ?>" alt="img-property">
                </div>
                <?php /* ?>
                <div class="top">
        ...
        <div class="archive-bottom">
            <div class="content-top">
                <h6 class="imovel-title"><a href="<?php echo get_permalink(); ?>" class="link text-line-clamp-1"><?php the_title(); ?></a></h6>
                <div class="location">
